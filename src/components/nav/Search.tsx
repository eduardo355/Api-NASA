...
const Search = () => {
    const { SearchInput, SetSearch } = SearchGlobal()
    ...
    <div className="rounded-lg p-5">
        <div className="flex">
        <div className="flex w-10 items-center justify-center rounded-tl-lg rounded-bl-lg border-r border-gray-400 bg-gray-200 p-5">
